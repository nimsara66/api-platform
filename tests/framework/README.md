...
make coverage-report      # merges suites/it/coverage-out and renders text + HTML reports
# Open suites/it/coverage-out/index.html to navigate to each component report.
