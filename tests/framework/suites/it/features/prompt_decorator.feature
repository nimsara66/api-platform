...
Feature: Prompt decorator
  ...
  # its own response ("json" field). Since prompt-decorator rewrites the request body before it
  # reaches the upstream, the echoed body proves the decoration actually happened.
