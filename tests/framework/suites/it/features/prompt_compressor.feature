...
Feature: Prompt compressor policy
  ...
  # its own response ("json"/"data" fields). Since prompt-compressor rewrites the request body
  # before it reaches the upstream, the echoed body proves the compression actually happened.
